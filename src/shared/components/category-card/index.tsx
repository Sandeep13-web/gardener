...
const CategoryCard: React.FC<Props> = ({ title, totalProducts, shopLink, image }) => {
  return (
    <div className='relative category-card'>
      ...
      <div>
        <Image src={image} className=" transition-all delay-200 duration-300 w-full " alt="Category Image" width={200} height={20} />
      </div>
      <div className='absolute left-[40px] top-[50%] transform translate-y-[-50%] flex flex-col gap-[10px] z-[9]'>
        ...
        <p className='text-xs text-gray-450 uppercase font-normal'>{totalProducts} Products</p>
