...
const CategoryCard: React.FC<Props> = ({ title, totalProducts, shopLink, image }) => {
  return (
    <div className='relative category-card'>
      ...
      <div>
        <Image src={image} className=" h-auto transition-all delay-200 duration-300" alt="Category Image" width={100} height={40} />
      </div>
      <div className='absolute left-[40px] top-[50%] transform translate-y-[-50%] flex flex-col gap-[10px] z-[9]'>
        ...
        <Link href={shopLink} className='text-[#253237] transition-all delay-100 text-sm hover:text-[#07a04b] hover:ml-[10px] flex items-center gap-1 font-normal'>
          Shop Now
